...
from vocab import get_glove, get_alphabet
...
tf.app.flags.DEFINE_bool("use_char_based_embeddings", True, "Choose whether to augment GloVe word embeddings with character-based embeddings")
tf.app.flags.DEFINE_integer("word_len", 16, "Maximum number of characters in a word. Used for character embeddings.")
tf.app.flags.DEFINE_integer("char_emb_size", 20, "Character embedding size")
tf.app.flags.DEFINE_integer("kernel_size", 5, "Kernel size used in 1D Convolution for generating feature vectors")
tf.app.flags.DEFINE_integer("char_based_embedding_size", 100, "Size of character-based word embeddings")
...
def main(unused_argv):
    ...
    # Define train_dir
    #FLAGS.experiment_name = "baseline_debug"
	...
	# Can throw an error depending on the CUDA version
